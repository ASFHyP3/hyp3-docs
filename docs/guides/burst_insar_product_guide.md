...
InSAR jobs can be processed on the basis of individual [radar bursts](#sentinel-1-bursts "Jump to the Sentinel-1 Bursts 
...
### Single-Burst InSAR
ASF's original burst-based InSAR job type, `INSAR_ISCE_BURST`, only accepts a single pair of SLC bursts. This job type 
