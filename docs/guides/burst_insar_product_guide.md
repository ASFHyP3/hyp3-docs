...
- The *look vectors* theta (θ) and phi (φ) describe the elevation and orientation angles of the look vector. The look vectors refer to the look direction back towards the sensor. 
