...
The water mask is generated using data from OpenStreetMaps and/or ESA WorldCover depending on location. Areas within Canada, Alaska, and Russia are primarily covered by ESA WorldCover data, while the rest of the world is covered by OpenStreetMaps data. Water masks were previously generated from the GSHHG dataset in the previous hyp3-isce2 version (V0.10.0).
