...
There are some ancillary products output products that change very little through time. Instead of 
re-generating these reference products with each OPERA RTC product, they are generated once for each 
